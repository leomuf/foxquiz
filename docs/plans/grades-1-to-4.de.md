...
- weiterhin drei bis fünf Antwortmöglichkeiten pro Frage
...
- [ ] Im Auswahlfeld für Klasse/Schuljahr die Klassen 1 bis 4 ergänzen.
- [ ] Die internen Werte konsistent als `Klasse 1`, `Klasse 2`, `Klasse 3` und `Klasse 4` an das Backend senden.
- [ ] Die sichtbaren Bezeichnungen in allen unterstützten Sprachen ergänzen:
...
- [ ] Die Auswahl logisch von Klasse 1 bis Klasse 12 sortieren.
- [ ] Die bisherige Standardauswahl Klasse 5 ausdrücklich beibehalten, damit die Erweiterung das bisherige Standardverhalten nicht unbeabsichtigt verändert.
- [ ] Den bestehenden strukturierten Request mit `grade`, `subject`, `topic` und `preferred_language` unverändert weiterverwenden.
...
- [ ] Die bisherige Zielgruppe von Alter 10–18 auf etwa 6–18 Jahre erweitern.
- [ ] Die fest kodierte Einteilung Klasse 5–8 und Klasse 9–12 durch vier pädagogische Gruppen ersetzen:
  - Klasse 1–2, etwa 6–8 Jahre
  - Klasse 3–4, etwa 8–10 Jahre
  - Klasse 5–8, etwa 10–14 Jahre
  - Klasse 9–12, etwa 14–18 Jahre
- [ ] Für Klasse 1–2 sehr kurze, konkrete und leicht lesbare Formulierungen verlangen.
- [ ] Für Klasse 3–4 einfache, aber etwas ausführlichere Fragen mit anschaulichen Beispielen erlauben.
- [ ] Die bestehenden Regeln für Klasse 5–8 und Klasse 9–12 inhaltlich erhalten.
- [ ] Den vorgelagerten Curriculum-Check anweisen, bei Klasse 1–4 besonders auf kognitive Angemessenheit, einfache konkrete Themen und altersgerechten Umfang zu achten.
- [ ] Den LLM-as-a-Judge anweisen, die Grundschulregeln ausdrücklich mitzuprüfen.
- [ ] Beispiele und Beschreibungen im Pydantic-Modell von einer ausschließlichen Klasse-5-Perspektive auf Klasse 1–12 erweitern.
- [ ] Das verwendete Gemini-Modell und die bestehende Workflow-Architektur unverändert lassen.
...
- [ ] Fragen und Antworten für Klasse 1–4 deutlich kürzer formulieren.
- [ ] Für Klasse 1–2 exakt drei Antwortmöglichkeiten verlangen.
- [ ] Für Klasse 3–4 weiterhin drei bis fünf Antwortmöglichkeiten erlauben.
- [ ] Erklärungen für Klasse 1–2 auf ein bis zwei kurze Sätze begrenzen.
- [ ] Komplizierte Distraktoren vermeiden.
- [ ] Keine Verneinungsfragen wie „Welche Antwort ist nicht richtig?“ verwenden.
- [ ] Doppelte Verneinungen vollständig ausschließen.
- [ ] Einfache und konkrete Themen bevorzugen.
- [ ] Abstrakte oder mehrdeutige Themen durch den Curriculum-Check klären lassen, bevor ein Quiz generiert wird.
- [ ] Den Judge dieselben Struktur- und Sprachregeln prüfen lassen.
...
- [ ] Den bestehenden Ablauf mit Auswahl von Klasse, Schulfach und Thema beibehalten.
- [ ] Keine neue Eingabemethode oder Grundschul-Sonderoberfläche entwickeln.
- [ ] In README und Spezifikation klarstellen, dass jüngere Kinder FoxQuiz zunächst gemeinsam mit einer erwachsenen Begleitperson nutzen sollen.
- [ ] Sicherstellen, dass diese Abgrenzung nicht als technische Einschränkung des generierten Quiz missverstanden wird: Das Quiz selbst muss trotzdem altersgerecht sein.
