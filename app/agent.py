...
async def quiz_generation(ctx: Context, node_input: Any) -> Event:
    ...
    prompt += (
        ...
        "4. Every option within one question must be meaningfully distinct and unique after Unicode normalization, trimming or collapsing whitespace, and ignoring capitalization. Before returning the JSON, compare every pair of options in each question and replace repeated or equivalent choices with genuinely different distractors.\n"
